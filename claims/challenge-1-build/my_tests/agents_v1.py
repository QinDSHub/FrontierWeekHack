...
# adjustment-1: make "status" excluded in the inputs for LLM
# adjustment-2: save outputs from second agent locally
...
class ClaimsTriageAgentNew:
    ...
    def create(self):
        ...
        self.agent = self.client.agents.create_version(
            agent_name="claims-triage-agent-new",
...
class ClaimsDecisionAgentNew:
    ...
    def create(self):
        ...
        self.agent = self.client.agents.create_version(
            agent_name="claims-decision-agent-new",
            definition=PromptAgentDefinition(
                model=MODEL_DEPLOYMENT_NAME,
                instructions=system_prompt,
            ),
